...
import AuthIllustration from './AuthIllustration'; // Import the SVG component
    ...
    return (
        <div className="min-h-screen w-full flex flex-col md:flex-row bg-background">
            ...
            <div className="w-full md:w-1/2 lg:w-2/5 xl:w-1/3 h-screen flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 order-2 md:order-1">
                <div className="w-full max-w-sm"> {/* Constrain form width */}
                    {children} {/* Render the Signin/Signup form here */}
                </div>
            </div>
